...
START_WEIGHT = 63.0  # Starting weight (kg)
...
print(f"{'Day':>3} {'Weight (kg)':>12} {'BMR (kcal)':>12} {'摂取カロリー(kcal)':>30}")
print("-" * 60)
...
for day in range(1, DAYS + 1):
    ...
    print(f"{day:3d} {weight:12.2f} {bmr:12.1f} {total_energy:30.1f}")
```
